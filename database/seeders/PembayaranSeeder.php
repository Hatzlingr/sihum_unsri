...
class PembayaranSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('pembayaran')->insert([
            ...
            // Pembayaran awal - mahasiswa 2 (Rusunawa Bukit, Rp 300.000)
            [
                'pendaftaran_id'    => 2,
                'perpanjangan_id'   => null,
                'jenis_pembayaran'  => 'Awal',
                'jumlah_bayar'      => 300000.00,
                'bukti_transfer'    => 'bukti/pembayaran/2/transfer_april2026.jpg',
            ...
            // Pembayaran perpanjangan - mahasiswa 1 (Rp 150.000 * 6 bulan = Rp 900.000)
            [
                'pendaftaran_id'    => null,
                'perpanjangan_id'   => 1,
                'jenis_pembayaran'  => 'Sewa Lanjutan',
                'jumlah_bayar'      => 900000.00,
            ...
            // Tagihan belum dibayar - mahasiswa 3 (Rusunawa KIPK, Rp 150.000)
            [
                'pendaftaran_id'    => 3,
                'perpanjangan_id'   => null,
                'jenis_pembayaran'  => 'Awal',
